package com.abhishek.zenq.AdapterFleet_Owner;
...
public class AdapterAllBid extends RecyclerView.Adapter<AdapterAllBid.ViewHolder> {
    ...
    public void onBindViewHolder(  AdapterAllBid.ViewHolder holder, final int position) {
        holder.tv_to.setText(allBidBeanList.get(position).getTo_address());
        holder.tv_to_add.setText(allBidBeanList.get(position).getTo_address());
        holder.tv_from.setText(allBidBeanList.get(position).getFrom_address());
        holder.tv_from_add.setText(allBidBeanList.get(position).getFrom_address());
